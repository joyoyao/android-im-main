 ...
 * </ul>
 */
public class RCCircleFlowIndicator extends View implements FlowIndicator,
        AnimationListener {
     ...
     * @param context
     */
    public RCCircleFlowIndicator(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public RCCircleFlowIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        // Retrieve styles attributs
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.RCCircleFlowIndicator);

        // Gets the active circle type, defaulting to "fill"

        int activeType = a.getInt(R.styleable.RCCircleFlowIndicator_RCActiveType,
        ...
        int activeColor = a
                ...
                .getColor(R.styleable.RCCircleFlowIndicator_RCActiveColor,
        ...
        int inactiveType = a.getInt(
                ...
                R.styleable.RCCircleFlowIndicator_RCInactiveType, STYLE_STROKE);
        ...
        int inactiveColor = a.getColor(
                ...
                R.styleable.RCCircleFlowIndicator_RCInactiveColor,
                inactiveDefaultColor);

        // Retrieve the radius
        mRadius = a.getDimension(R.styleable.RCCircleFlowIndicator_RCRadius, 4.0f);

        mRadiusActive = mRadius;
        mRadiusInactive = mRadius;

        // Retrieve the spacing
        spacing = a.getDimension(R.styleable.RCCircleFlowIndicator_RCSpacing, 4.0f);

        // We want the spacing to be center-to-center
        spacing += 2 * mRadiusActive;

        // Retrieve the fade out time
        fadeOutTime = a.getInt(R.styleable.RCCircleFlowIndicator_RCFadeOut, 0);

        mCentered = a.getBoolean(R.styleable.RCCircleFlowIndicator_RCCentered, false);

        mSnap = a.getBoolean(R.styleable.RCCircleFlowIndicator_RCSnap, false);
     ...
     */
    @Override
    public void setViewFlow(RCViewFlow view) {
        resetTimer();
        viewFlow = view;
