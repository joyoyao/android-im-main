 ...
 */
public class RCViewFlow extends AdapterView<Adapter> {
    ...
    public RCViewFlow(Context context) {
        super(context);
        mSideBuffer = 3;
        init();
    }

    public RCViewFlow(Context context, int sideBuffer) {
        super(context);
    ...
    public RCViewFlow(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray styledAttrs = context.obtainStyledAttributes(attrs,
                R.styleable.RCViewFlow);
        mSideBuffer = styledAttrs.getInt(R.styleable.RCViewFlow_RCSideBuffer, 1);
        init();
    }
