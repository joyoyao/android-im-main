...
public class TestMessageItemProvider extends IContainerItemProvider.MessageProvider<TestMessage> {
    ...
    @Override
    public void bindView(final View v, int position, TestMessage content, final UIMessage data) {
